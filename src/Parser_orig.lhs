...
> dqlOperators = ["+", "*", "/", "-"]
> dqlReserved = ["create", "get", "insert, true, false"]
...
> literalP = choice [int64LiteralP, stringLiteralP, boolLiteralP, charLiteralP]
> int64LiteralP :: Parser DibsAST
> int64LiteralP = do
>         n <- natural
...
> boolLiteralP = 
>	choice $ map try [do {reserved "true" ; return DibsBool True},
>	           > stringLiteralP = do
>       str <- stringLiteral
>       return $ DibsLiteral . DibsString $ str
>	do {reserved "false"; return DibsBool False}] 
> charLiteralP = 
>	
...
> dqlFuncParsers = [dqlGetP, dqlCondGetP, dqlInsertP, dqlCreateP] -- ordered by likelihood
